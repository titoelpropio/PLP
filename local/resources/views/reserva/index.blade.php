    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <tfoot>
            <tr>
            <td colspan="4">
              <font size="4" color="red">MONTO TOTAL $US.</font>
            </td>
            <td></td>
            <td align="center">
              <input type="text" name="montoTotal" id="montoTotal" size="7" style="text-align: center; font-size: 20px" value="0.0" readonly="" onkeypress="return bloqueo_de_punto(event)">
            </td>
            <td align="center"></td>
            </tr>
            <tr>
            <td colspan="4">
              <font size="4" color="red">MONTO TOTAL BS.</font>
            </td>
            <td></td>
            <td align="center">
              <input type="text" name="montoTotalB" id="montoTotalB" size="7" style="text-align: center; font-size: 20px" value="0.0" readonly="" onkeypress="return bloqueo_de_punto(event)">
            </td>
            <td align="center"></td>
            </tr>
        </tfoot>
