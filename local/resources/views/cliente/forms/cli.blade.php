...
<div class="form-group">
    {!!Form::label('telefono_adicional','Celular Ref:')!!}
    {!!Form::text('telefono_adicional',null,['class'=>'form-control ','placeholder'=>'Ingresa el Celular de referencia del usuario'])!!}
</div>
