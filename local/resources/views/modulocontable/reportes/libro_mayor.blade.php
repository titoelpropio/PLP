...
<center><H2><strong>LIBRO MAYOR</strong></H2></center>
<div class="row">	
    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12">
        <div class="form-group" >
            <button class="btn btn-primary" onclick="reporte_libro_mayor(1)"> Buscar</button><br>
    ...
    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12 pull-right">
        <center>
            ...
            <div class="form-group" >
                <button class="btn btn-success" onclick="reporte_libro_mayor(0)">Gestion actual</button>
            </div>
            <?php
                }
                else {
        ...
        <center>
            <div class="form-group" >
                <button class="btn btn-default" onclick="ExportarExcel('tabla_LM','LibroMayor')" title="Exportar a Excel"><img src="images/excel.png"></button>
            </div>
        </center>
    </div>	
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="table-responsive">	
            ...
            <table class="table table-striped table-bordered table-condensed table-hover" name="tabla_LM" id="tabla_LM">
                <thead style='background-color: #8CDF33'>
                <th style="vertical-align: middle;"><CENTER>ASIENTO</CENTER></th>
