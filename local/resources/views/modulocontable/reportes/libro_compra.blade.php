...
<div class="row">
    ...
    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12 pull-right">
        ...
        <center>
            <div class="form-group" >
                <button class="btn btn-default" onclick="ExportarExcel('tabla_LC','LibroCompras')" title="Exportar a Excel"><img src="images/excel.png"></button>
                <button class="btn btn-default" onclick="ExportarTxt('tabla_LC','LibroCompras')" title="Exportar a Txt"><img src="images/txt.png"></button>
            </div>
        </center>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="table-responsive">
            ...
            <table class="table table-striped table-bordered table-condensed table-hover" style="font-size: 11;" name="tabla_LC" id="tabla_LC">
