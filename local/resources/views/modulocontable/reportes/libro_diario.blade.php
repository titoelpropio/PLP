...
<center><H2><strong>LIBRO DIARIO</strong></H2></center>
<div class="row">
    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12">
        <div class="form-group" >
            <button class="btn btn-primary" onclick="reporte_libro_diario(1)"> Buscar</button><br>
    ...
    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12 pull-right">
        ...
        <center>
            <div class="form-group" >
                <button class="btn btn-default" onclick="ExportarExcel('tabla_LD','LibroDiario')" title="Exportar a Excel"><img src="images/excel.png"></button>
            </div>
        </center>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="table-responsive">
            ...
            <table class="table table-striped table-bordered table-condensed table-hover" name="tabla_LD" id="tabla_LD">
                <thead style='background-color: #8CDF33'>
                <th style="vertical-align: middle;"><CENTER>FECHA</CENTER></th>
                <th style="vertical-align: middle;"><CENTER>DESCRIPCIÓN</CENTER></th>
