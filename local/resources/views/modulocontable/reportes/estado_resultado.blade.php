...
<center><H2><strong>ESTADO DE RESULTADOS</strong></H2></center>
<div class="row">	
    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12">
        <div class="form-group" >
            <button class="btn btn-primary" onclick="estado_resultado(1)"> Buscar</button><br>
    ...
    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12 pull-right">
        <center>
            ...
            <div class="form-group" >
                <button class="btn btn-success" onclick="estado_resultado(0)">Gestion actual</button>
            </div>
            <?php
                }
                else {
        ...
        <center>
            <div class="form-group" >
                <button class="btn btn-default" onclick="ExportarExcel('tabla_ER','EstadodeResultado')" title="Exportar a Excel"><img src="images/excel.png"></button>
            </div>
        </center>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="table-responsive">	
            ...
            <table class="table table-striped table-bordered table-condensed table-hover" name="tabla_ER" id="tabla_ER">
                ...
                <th style="vertical-align: middle;"><CENTER>GASTOS $us.</CENTER></th>
                <th style="vertical-align: middle;"><CENTER>INGRESOS $us.</CENTER></th>
                <th style="vertical-align: middle;"><CENTER>GASTOS Bs.</CENTER></th>
                <th style="vertical-align: middle;"><CENTER>INGRESOS Bs.</CENTER></th>
                </thead>
