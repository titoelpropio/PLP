...
<div class="form-group">
    ...
    {!!Form::text('matricula','0',['class'=>'form-control ','placeholder'=>'Ingresa la Matricula'])!!}
...
<div class="form-group">
    ...
    {!!Form::text('norte','0',['class'=>'form-control ','placeholder'=>'Ingresa la colindacion norte'])!!}
</div>
</div>
...
<div class="form-group">
    ...
    {!!Form::number('medida_norte','0',['class'=>'form-control ','placeholder'=>'Ingresa la medida'])!!}
</div>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
<div class="form-group">
    {!!Form::label('sur','Sur:')!!}
    {!!Form::text('sur','0',['class'=>'form-control ','placeholder'=>'Ingresa la colindacion sur'])!!}
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
...
<div class="form-group">
    ...
    {!!Form::number('medida_sur','0',['class'=>'form-control ','placeholder'=>'Ingresa la medida'])!!}
</div>
</div><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">

<div class="form-group">
    {!!Form::label('este','Este:')!!}
    {!!Form::text('este','0',['class'=>'form-control ','placeholder'=>'Ingresa la colindacion este'])!!}
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
...
<div class="form-group">
    ...
    {!!Form::number('medida_este','0',['class'=>'form-control ','placeholder'=>'Ingresa la medida'])!!}
</div>
</div><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">

<div class="form-group">
    {!!Form::label('oeste','Oeste:')!!}
    {!!Form::text('oeste','0',['class'=>'form-control ','placeholder'=>'Ingresa la colindacion oeste'])!!}
</div>
</div>
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
...
<div class="form-group">
    ...
    {!!Form::number('medida_oeste','0',['class'=>'form-control ','placeholder'=>'Ingresa la medida'])!!}
</div>
</div>
     </div>      
